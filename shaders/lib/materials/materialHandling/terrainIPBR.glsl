                            ...
                            if (mat < 10056) {
                                if (mat < 10052) { // Water Cauldron
                                    ...
                                    if (cauldronInteriorCheck && NdotU > 0.9) {
                                        ...
                                        #if defined GBUFFERS_TERRAIN && defined IPBR_COMPLEMENTARY_WATER
                                            // le perfecto bliss: fenced off by default so Bliss keeps its own
                                            // water look.  Set IPBR_WATER_MATERIAL 1 to opt in.
                ...
                if (mat < 10960) {
                    ...
                    if (mat < 10992) {
                        ...
                        if (mat < 11008) {
                            ...
                            if (mat < 11016) {
                                if (mat < 11012) { // Vine, Pale Hanging Moss
